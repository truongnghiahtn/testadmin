      ...
      <div className="iq-menu-bt-sidebar">
        <div className="iq-menu-bt align-self-center">
          <div className="wrapper-menu">
            <div className="main-circle"><i className="ri-more-fill" /></div>
            <div className="hover-circle"><i className="ri-more-2-fill" /></div>
          </div>
        </div>
      </div>
    </div>
    <div id="sidebar-scrollbar">
      <nav className="iq-sidebar-menu">
        <ul className="iq-menu">
          <li className="iq-menu-title"><i className="ri-subtract-line" /><span>Trang chủ</span></li>                  
          <li className="active">
            <a href="dashboard-1.html" className="iq-waves-effect"><i className="ri-home-8-fill" /><span>Home</span></a>
          </li>
          <li className="iq-menu-title"><i className="ri-subtract-line" /><span>Quản lý</span></li>
          <li className>
            <a href="account.html" className="iq-waves-effect"><i className="fa fa-user-circle" aria-hidden="true" /><span>User</span></a>
          </li><li>
          </li><li className>
            <a href="website.html" className="iq-waves-effect"><i className="fa fa-chrome" aria-hidden="true" /><span>Website</span></a>
          </li><li>
            <a href="javascript:void(0);" className="iq-waves-effect"><i className="fa fa-address-card-o" aria-hidden="true" /><span>Khách hàng</span><i className="ri-arrow-right-s-line iq-arrow-right" /></a>
            <ul className="iq-submenu">
              <li><a href="customer.html"><i className="fa fa-id-badge" aria-hidden="true" />Thông tin</a></li>
              <li><a href="contribute.html"><i className="fa fa-book" aria-hidden="true" />Đóng góp</a></li>
            </ul>
          </li>
          <li>
            <a href="javascript:void(0);" className="iq-waves-effect"><i className="fa fa-language" aria-hidden="true" /><span>Ngôn ngữ</span><i className="ri-arrow-right-s-line iq-arrow-right" /></a>
            <ul className="iq-submenu">
              <li><a href="english.html"><i className="fa fa-flag-checkered" aria-hidden="true" />Tiếng anh</a></li>
              <li><a href="film.html"><i className="fa fa-film" aria-hidden="true" />Tựa đề phim</a></li>
            </ul>
          </li>
        </ul>
      </nav>
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            <ul className="navbar-nav ml-auto navbar-list">
              <li className="nav-item iq-full-screen">
                <a href="#" className="iq-waves-effect" id="btnFullscreen"><i className="ri-fullscreen-line" /></a>
              </li>
            ...
            <li>
              ...
              <div className="iq-sub-dropdown iq-user-dropdown">
                <div className="iq-card shadow-none m-0">
                  <div className="iq-card-body p-0 ">
                    <div className="bg-primary p-3">
                      <h5 className="mb-0 text-white line-height">Hello Bini Jets</h5>
              ...
              <div className="iq-card">
                <div className="iq-card-body iq-bg-primary rounded">
                  <div className="d-flex align-items-center justify-content-between">
                    <div className="rounded-circle iq-card-icon bg-primary"><i className="fas fa-language" /></div>
                    <div className="text-right">                                 
                      <h2 className="mb-0"><span className="counter">5600</span></h2>
            ...
            <div className="col-md-6 col-lg-3">
              <div className="iq-card">
                <div className="iq-card-body iq-bg-warning rounded">
                  <div className="d-flex align-items-center justify-content-between">
                    <div className="rounded-circle iq-card-icon bg-warning"><img src="images/language/uk_big.png" alt /></div>
                    <div className="text-right">                                 
                      <h2 className="mb-0"><span className="counter">3450</span></h2>
            ...
            <div className="col-md-6 col-lg-3">
              <div className="iq-card">
                <div className="iq-card-body iq-bg-danger rounded">
                  <div className="d-flex align-items-center justify-content-between">
                    <div className="rounded-circle iq-card-icon bg-danger"><img src="images/language/france_big.png" alt /></div>
                    <div className="text-right">                                 
                      <h2 className="mb-0"><span className="counter">3500</span></h2>
            ...
            <div className="col-md-6 col-lg-3">
              <div className="iq-card">
                <div className="iq-card-body iq-bg-info rounded">
                  <div className="d-flex align-items-center justify-content-between">
                    <div className="rounded-circle iq-card-icon bg-info"><img src="images/language/japan_big.png" alt /></div>
                    <div className="text-right">                                 
                      <h2 className="mb-0"><span className="counter">4500</span></h2>
